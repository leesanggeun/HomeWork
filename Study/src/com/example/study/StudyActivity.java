	...
	ResponseHandler<String> responseHandler = new ResponseHandler<String>() {
		...
		public String handleResponse(HttpResponse response) {
			...
			try {
				...
				try {
					...
					loadHandler.post(new Runnable() {
						...
						public void run() {
							...
							Log.i("actionBar", "favicon log2---->" + dr);
				 ...
				 * loadHandler.post(new Runnable() {
				 * 
				 * @Override public void run() { // TODO 자동 생성된 메소드 스텁
				 * 
				 * addressName = (sb.substring( sb.indexOf("<title>") + 7,
				 ...
				 * .setIcon(R.drawable.ic_launcher) .setText(addressName)
				 * 
				 * .setTag(Tag) // 직접 tag 를 입력 받음 .setTabListener( new
				 * TabListener<Fragb>( StudyActivity.this, Tag, Fragb.class)));
				 * 
				 * 
				 * 
				 * }
